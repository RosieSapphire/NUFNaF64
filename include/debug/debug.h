...
#define UNFL_DEBUG_H
    ...
    *********************************/
    ...
    #ifndef DEBUG_MODE
        #define DEBUG_MODE    DEBUG // Enable/Disable debug mode
    #endif
    
    // Settings
    #define DEBUG_INIT_MSG    1   // Print a message when debug mode has initialized
    #define AUTOPOLL_ENABLED  DEBUG   // Automatically poll the USB on a timer
    ...
    #define USE_RDBTHREAD DEBUG       // Create a remote debugger thread
